...
export default class HappyNewsForm extends Component {
  ...
  submitHandler = event => {
    ...
    if (this.state.newsUrlInput.length < 20 || this.state.newsHeadlineInput.length < 15 || this.state.newsDescriptionInput.length < 35) {
      ...
      .then(res => res.json())
      .then(alert(`Your news submission has been added to the happy mood page!`))
    }
  }
  ...
  render() {
    return (
      ...
      <input className="inputField" type="text" value={this.state.newsHeadlineInput} name="newsHeadlineInput" placeholder="News Headline" onChange={this.changeHandler}/>
      <br />
      <input className="inputField" type="text" value={this.state.newsUrlInput} name="newsUrlInput" placeholder="News URL" onChange={this.changeHandler}/>
      <br />
      <input className="inputField" type="text" value={this.state.newsDescriptionInput} name="newsDescriptionInput" placeholder="Article Description" onChange={this.changeHandler}/>
